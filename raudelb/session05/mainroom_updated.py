    ...
    try:
        ...
        if full_name == 'list':
            ...
            try:
                ...
                donation_amount = int(input('Please, enter the donation amount:'))

                for i in my_list:
                    if i[0] == full_name:
                        temp = i[1].append(donation_amount)
        ...
        print('Sorry,  you did something incorrectly that produced an ', error_msg)

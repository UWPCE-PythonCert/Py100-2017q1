...
class TestDonationsTable(TestCase):
    ...
    def test__get_per_donor_per_date(self):
        ...
        donations_date_1 = donations_table.get_per_donor_per_date(donor_id.value, date(2012, 4, 12))
        ...
        donations_date_2 = donations_table.get_per_donor_per_date(donor_id.value, date(2014, 2, 8))
    ...
    def test__add_donation_existing_date(self):
        ...
        donations = donations_table.get_per_donor_per_date(donor_id.value, date(2012, 4, 12))
    ...
    def test__add_donation_new_date(self):
        ...
        donations = donations_table.get_per_donor_per_date(donor_id.value, date(2000, 6, 12))
    ...
    def test__add_donor(self):
        ...
        donor_id = PersonId(PersonName("M", "Bill", "Watrous"), date(1954, 5, 13))
